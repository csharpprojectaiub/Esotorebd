                    ...
                    <div class="addproductoption">
                        <form action="addproduct.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input id="pname" name="pname" type="text" placeholder="Enter Product Name" class="form-control  "required >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input id="pprice" name="pprice" type="text" placeholder="Enter product Price" class="form-control "required >
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input id="pquantity" name="pquantity" type="text" placeholder="Enter product Quantity" class="form-control "required >

                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="pquantity">Product Description</label>
                                <div class="col-md-6">
                                    <textarea style="resize: none;border-radius: 8px" name="pdesc" id="" cols="45" rows="5" ></textarea>

                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-4 control-label" for="pimage">Product Image</label>
                                <div class="col-md-6">
